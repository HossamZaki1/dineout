...
class ConversationMeta {
  ...
  final List<String>
  restaurantSuggestionNames; // Names of restaurants suggested in this conversation
  final int totalRestaurantSuggestions; // Total count of restaurant suggestions
  final List<String>
  restaurantPhotoUrls; // Photo URLs of restaurants suggested in this conversation
  ...
  factory ConversationMeta.fromApi(Map<String, dynamic> map) =>
      ConversationMeta(
        id: map['id'] as String,
        ...
        restaurantSuggestionNames: List<String>.from(
          map['restaurant_suggestion_names'] ?? [],
        ),
        totalRestaurantSuggestions:
            (map['total_restaurant_suggestions'] ?? 0) as int,
        restaurantPhotoUrls: List<String>.from(
          map['restaurant_photo_urls'] ?? [],
        ),
      );
  ...
  ConversationMeta copyWith({
    ...
    return ConversationMeta(
      ...
      restaurantSuggestionNames:
          restaurantSuggestionNames ?? this.restaurantSuggestionNames,
      totalRestaurantSuggestions:
          totalRestaurantSuggestions ?? this.totalRestaurantSuggestions,
  ...
  factory ConversationMeta.fromMap(Map<String, dynamic> map) {
    return ConversationMeta(
      ...
      restaurantSuggestionNames: map['restaurantSuggestionNames'] != null
          ...
          : [],
      totalRestaurantSuggestions:
          (map['totalRestaurantSuggestions'] ?? 0) as int,
  ...
  factory ConversationMeta.fromJson(String source) =>
      ConversationMeta.fromMap(json.decode(source) as Map<String, dynamic>);
}
...
class ConversationMessage {
  ...
  restaurantSuggestions; // Add restaurant suggestions
